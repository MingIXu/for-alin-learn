...
public class Generator {
    ...
    private final static String DB_URL = "jdbc:mysql://101.132.129.130:3306/alin?serverTimezone=Asia/Shanghai&useUnicode=true&characterEncoding=utf8&useSSL=false";
    private final static String DB_USER_NAME = "root";
    private final static String DB_PASSWORD = "mysql806001926";

    private final static String PACKAGE_NAME = "com.example.demo.admin";
    // 需要生成的表名
